...
- “No akinesia, no dyskinesia, they mean the same thing.” [[speaker claims equivalence; keep as stated\|speaker claims equivalence; keep as stated]]
...
- **C**lopidogrel (or other antiplatelet: prasugrel/ticagrelor mentioned)
...
- [ ] CAD spectrum + rough occlusion % + ST/biomarker patterns
- [ ] Supply ischemia (STEMI) vs demand ischemia (others)
- [ ] Diamond classification: 3 criteria + typical/atypical/non-anginal labels
- [ ] Chest pain workup ladder: EKG → troponin/CKMB → stress test → cath timing (emergent/urgent/elective)
- [ ] Stress test selection rules (baseline EKG; prior CABG/HF)
- [ ] Reversibility concept for echo/nuclear stress tests
- [ ] Cath: 3+ vessels or proximal big arteries → CABG; otherwise stent
- [ ] MONA BASH C + who gets nitrates/clopidogrel + right-sided MI nitrate caveat
