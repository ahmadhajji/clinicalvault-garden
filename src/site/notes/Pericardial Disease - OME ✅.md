...
- **Tamponade**: a **clinical diagnosis** (Beck triad + clear lungs + pulsus paradoxus > `10 mmHg`) → **emergent pericardiocentesis** (do not delay for echo).
- **Constrictive pericarditis**: fibrosis → rigid box limiting filling → **pericardial knock**; diagnose with **echocardiogram**; treat with **pericardiectomy**.
...
- [ ] Don’t over-memorize etiologies; learn response patterns.
- [ ] Pericarditis: pleuritic + positional chest pain; electrocardiogram diffuse ST elevation + PR depression.
- [ ] Echo does not show inflammation (but can show effusion).
- [ ] Treat pericarditis: nonsteroidal anti-inflammatory drugs + colchicine; avoid steroids unless refractory.
- [ ] Effusion: congestive heart failure-type symptoms; diagnose with echo; treat cause; window if recurrent/refractory/large.
- [ ] Tamponade: Beck triad + clear lungs + pulsus paradoxus >10 mmHg → emergent pericardiocentesis.
- [ ] Constrictive: pericardial knock + diastolic congestive heart failure; echo; pericardiectomy.
